...
# Annoted - type with description
# class Review(TypedDict):
#     summary: Annotated[str, "A brief summary of the review"]
#     sentiment: Annotated[str, "Return the sentiment of the review Positive, Negative or Neutral"]
...
class Review(TypedDict):
    ...
    summary: Annotated[str, "A brief summary of the review"]
    sentiment: Annotated[Literal['pos', 'neg'], "Return the sentiment of the review Positive, Negative or Neutral"]
